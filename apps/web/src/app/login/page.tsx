...
export default function LoginPage() {
  ...
  const { login, user, isLoading, isInitialized, initialize } = useAuthStore();
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1 flex justify-between items-center">
              Password
              <Link href="/forgot-password" size={10} className="text-[10px] text-[#6366F1] hover:underline normal-case tracking-normal">Forgot?</Link>
            </label>
            <div className="relative">
